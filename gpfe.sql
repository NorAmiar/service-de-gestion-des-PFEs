...
--
-- Host: localhost
-- Generation Time: Apr 10, 2020 at 03:16 PM
...
CREATE TABLE `departement` (
  ...
  `affectationAuto` tinyint(1) NOT NULL DEFAULT 0,
  `depotSujet` tinyint(1) NOT NULL DEFAULT 0,
  `choixSujet` tinyint(1) NOT NULL DEFAULT 0,
  `ficheSuivi` tinyint(1) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
